# SMP-CAIL2021：Task 1.2 -- Cross Domain between Penal and Maritime Law

代码来源于： **中国法研杯司法人工智能挑战赛（CAIL2020）** 论辩挖掘赛道参考代码和模型。
...
`xingfa.train.csv/haishi.valid.csv`： 包含了刑法裁判文书和海事诉讼裁判文书中的互动论点对。分别包含以下维度：
